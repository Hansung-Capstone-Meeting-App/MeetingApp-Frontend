        ...
        <View style={styles.statsRow}>
          ...
          <View style={styles.statCard}>
            ...
            <Text style={styles.statValue}>
              {meetings.reduce((acc, m) => acc + m.sessions.filter((s) => s.status === 'ongoing').length, 0)}
            </Text>
...
const styles = StyleSheet.create({
  ...
  greeting: { fontSize: 14, color: COLORS.subtext, marginBottom: 2 },
  ...
  statIconWrap: {
    width: 38, height: 38, borderRadius: 10, alignItems: 'center', justifyContent: 'center', marginBottom: 8,
  },
  ...
  meetingMainLeft: { flexDirection: 'row', alignItems: 'center', flex: 1 },
  meetingMainIconWrap: {
    width: 56, height: 56, borderRadius: 16, backgroundColor: 'rgba(255,255,255,0.2)',
    alignItems: 'center', justifyContent: 'center', marginRight: 16,
  },
  meetingMainTextWrap: { flex: 1 },
  meetingMainTitle: { fontSize: 22, fontWeight: '800', color: '#FFFFFF', letterSpacing: -0.5 },
  meetingMainDesc: { fontSize: 13, color: 'rgba(255,255,255,0.75)', marginTop: 3 },
  aiBanner: {
    flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between',
    backgroundColor: '#FDF4FF', borderRadius: 14, padding: 14, marginBottom: 24,
  ...
  aiBadge: {
    ...
    borderRadius: 8, paddingHorizontal: 8, paddingVertical: 4, gap: 3,
  },
  aiBadgeText: { color: '#FFFFFF', fontSize: 11, fontWeight: '800' },
  aiBannerTitle: { fontSize: 14, fontWeight: '700', color: COLORS.text },
  aiBannerDesc: { fontSize: 11, color: COLORS.subtext, marginTop: 1 },
  sectionHeader: {
  ...
  emptyCard: {
    backgroundColor: COLORS.surface, borderRadius: 16, padding: 32, alignItems: 'center', marginBottom: 24,
  },
  emptyText: { fontSize: 15, fontWeight: '600', color: COLORS.subtext, marginTop: 12 },
  emptySubtext: { fontSize: 12, color: '#A0AEC0', marginTop: 4, textAlign: 'center' },
  recentMeetingCard: {
    flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between',
    backgroundColor: COLORS.surface, borderRadius: 14, padding: 14, marginBottom: 10,
    shadowColor: '#000', shadowOffset: { width: 0, height: 1 }, shadowOpacity: 0.05, shadowRadius: 4, elevation: 2,
  },
  recentCardLeft: { flexDirection: 'row', alignItems: 'center', flex: 1, gap: 12 },
  recentAvatarCircle: {
    width: 44, height: 44, borderRadius: 12, backgroundColor: '#EEF2FF',
    alignItems: 'center', justifyContent: 'center',
  },
  recentAvatarText: { fontSize: 18, fontWeight: '700', color: COLORS.primary },
  recentMeetingName: { fontSize: 15, fontWeight: '600', color: COLORS.text },
  recentMeetingMeta: { fontSize: 12, color: COLORS.subtext, marginTop: 2 },
  sessionCountBadge: {
    backgroundColor: '#EEF2FF', borderRadius: 8, paddingHorizontal: 10, paddingVertical: 4,
  },
  sessionCountText: { fontSize: 12, fontWeight: '700', color: COLORS.primary },
});
